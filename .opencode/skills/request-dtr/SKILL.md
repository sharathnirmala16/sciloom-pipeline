---
name: request-dtr
description: API contract for the dtreg.request_dtr module. Covers the request_dtr function for making HTTP GET requests to datatype registry APIs and deserializing JSON responses.
---
