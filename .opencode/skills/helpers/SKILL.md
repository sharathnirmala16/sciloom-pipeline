---
name: helpers
description: API contract for the dtreg.helpers module. Covers utility functions including format_string for name normalization, get_prefix for URL prefix extraction, specify_cardinality for cardinality parsing, and generate_uid for sequential ID generation.
---
