---
name: from-static
description: API contract for the dtreg.from_static module. Covers the from_static function for loading cached DTR schema definitions from static JSON files bundled with the dtreg package.
---
