---
name: dtr-interface
description: API contract for the dtreg.dtr_interface module including the DataTypeReg protocol, select_dtr selector, and the Epic and Orkg DTR handler classes with their JSON-LD generation methods.
---
